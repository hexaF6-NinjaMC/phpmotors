<?php
    ...
    function regClient($clientFirstname, $clientLastname, $clientEmail, $clientPassword) {
        // Create a connection object using the phpmotors connection
        $db = phpmotorsConnect();
        // The SQL statement
        ...
        $stmt = $db->prepare($sql);
        // The next four lines will replace the placeholders in the SQL statement with the
    ...
    // checkExistingEmail() will check for an existing email address, and return a boolean int (0,1) response.
    ...
    function updatePassword($clientPassword, $clientId) {
        ...
        // The next two lines will replace the placeholders in the SQL statement with the
        // actual values in the variables, and tells the database the type of data it is.
        $stmt->bindValue(':clientPassword', $clientPassword, PDO::PARAM_STR);
        $stmt->bindValue(':clientId', $clientId, PDO::PARAM_STR);
