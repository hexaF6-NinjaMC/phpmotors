...
classificationList.addEventListener("change", function () {
    ...
    let classIdURL = "/app/vehicles/index.php?action=getInventoryItems&classificationId=" + classificationId;
...
function buildInventoryList(data) {
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<td><a href='/app/vehicles?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`;
        dataTable += `<td><a href='/app/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`;
    });
