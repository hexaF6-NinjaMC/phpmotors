<?php
    ...
    function buildVehiclesDisplay($vehicles) {
        ...
        foreach ($vehicles as $vehicle) {
            ...
            $dv .= '<li>';
            $dv .= "<a href='/app/vehicles/?action=vehicleInformation&invId=$vehicle[invId]'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
            $dv .= "<a href='/app/vehicles/?action=vehicleInformation&invId=$vehicle[invId]'><h2>$vehicle[invMake] $vehicle[invModel]</h2></a>";
